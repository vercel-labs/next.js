...
/**
 * The names of the `cacheLife` profiles that are defined in `next.config.ts`.
 *
 * This interface is augmented by the generated
 * `<distDir>/types/cache-life.d.ts` file, which also declares an overload of
 * `cacheLife()` for every profile. While it is empty, i.e. before the types
 * have been generated, any profile name is accepted.
 */
